package simulation.restoreMatrix;
...
class Solution {
    public int[][] restoreMatrix(int[] rowSum, int[] colSum) {
        ...
        while (cur_row < rows || cur_col < cols) {
            ...
            // I wrote this like this because it's possible that rowSum[cur_row] == colSum[cur_col] and we'll want to move both row and col pointers
            if (rowSum[cur_row] == 0) {
                cur_row++;
            }
            if (colSum[cur_col] == 0) {
